...
## No coding needed to use the software!

![Husmorph GUI Screenshot](doc_img/Deviation.png)
...
See the [Changelog](Changelog.md) for a list of updates and changes.
...
![Husmorph GUI Screenshot](doc_img/Plots.png)

*Based on our research, we recommend doing 50-100 trials to begin with, see fig. A. Use at least 100 images, preferably >200 images, see fig. B.*
